                                ...
                                @endphp
                                    @foreach ($clients as $client)
                                        <tr>
                                            ...
                                            @if (auth()->user()->role == 'super-admin')
                                                ...
                                                <td>
                                                    <form class="user-form"
                                                        action="{{ route('user.select.client', $client->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('POST')
                                            ...
                                            @endif
                                            <form action="{{ route('remark.client', $client->id) }}"
                                                method="POST">
                                                @csrf
                                        ...
                                        <div class="modal fade" id="ModalClientDetails-{{ $client->id }}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="show-info-client show-category"
                                                            style="margin-top:10px">
                                                            <label class="label-detail-client">Les
                                                                catégories</label>
                                                            <select
                                                                class="form-select form-select-sm info-client showCategoryClient"
                                                        ...
                                                        <div class="show-info-client show-product"
                                                            ...
                                                            <select
                                                                class="form-select form-select-sm info-client showProductClient"
                                                                aria-label=".form-select-sm example"
                            ...
                            <div class="modal-body">
                                ...
                                <div>
                                    ...
                                    <input id="updateClientName" type="text" class="form-control"
                                        name="newNom_client" placeholder="Entrer le client..."
                                ...
                                <div>
                                    <label class="form-label">Email</label>
                                    <input id="updateClientEmail" type="email" class="form-control"
                                        name="newEmail_client" placeholder="Entrer l'émail..."
                                ...
                                <div>
                                    ...
                                    <input id="updateClientVille" type="text" class="form-control"
                                        name="newVille_client" placeholder="Entrer la ville..."
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                updateProspectModal.addEventListener('show.bs.modal', event => {
                    ...
                    const clientAdress = button.getAttribute('data-adress');
                    ...
                    document.getElementById('updateClientAdress').value = clientAdress;
        ...
        <script>
            document.querySelectorAll(`.detailButton`).forEach(button => {
                ...
                button.addEventListener('click', function() {
                    ...
                    const clientAdress = this.getAttribute('data-adress') || 'Non disponible'
...
document.querySelectorAll('.detailButtonQuery').forEach(button => {
    button.addEventListener('click', function() {
        ...
        const clientName = this.getAttribute('data-name');|| 'Non disponible'
        const clientEmail = this.getAttribute('data-email') || 'Non disponible';
        const clientContact = this.getAttribute('data-contact');|| 'Non disponible'
        const clientAdress = this.getAttribute('data-adress') || 'Non disponible';
        const clientSociety = this.getAttribute('data-society')  || 'Particulier';
        const clientGSM1 = this.getAttribute('data-GSM1')  || 'Non disponible';
        const clientGSM2 = this.getAttribute('data-GSM2')  || 'Non disponible';
        const clientVille = this.getAttribute('data-ville');
        const clientRemark = this.getAttribute('data-remark');
        const clientUser = this.getAttribute('data-user')  || 'Personne';

        // Mise à jour des éléments HTML
        const updateTextContent = (selector, text) => {
            const element = document.querySelector(selector);
            if (element) {
                element.innerText = text ; // Affiche 'N/A' si le texte est vide
            }
        };

        updateTextContent('#showNameClient', clientName);
        updateTextContent('#showEmailClient', clientEmail);
        updateTextContent('#showContactClient', clientContact);
        updateTextContent('#showAdressClient', clientAdress);
        updateTextContent('#showSocietyClient', clientSociety);
        updateTextContent('#showGSM1Client', clientGSM1);
        updateTextContent('#showGSM2Client', clientGSM2);
        updateTextContent('#showVilleClient', clientVille);
        updateTextContent('#showRemarkClient', clientRemark);
        updateTextContent('#showUserClient', clientUser);
